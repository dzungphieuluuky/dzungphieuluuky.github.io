...
I'm fascinated by the intersection of mathematics, computer science, and physics. Mathematically speaking, I'm quite interested in continuous mathematics that has stochastic, complex and dynamical properties.
...
-  **Large Language Models**: Looped language models, recursive language models, small language models.
...
- I feel that I have a strong sense of language understanding. I can feel quite lots of intangible things related to natural languages, including the subtle difference between synonyms, which we consider to have the same meaning.
- Around 90% of my knowledge and exprience come from my own self study journey rather than my formal academic studies at schools (now university). I think I'm quite similar to an autodidact, that guy who learns everything he wants, which in my case, everything that I found to be fancy enough.

# Weaknesses

- Immense amount of imposter syndrome, the bullshit phenomenon that drastically pull you down by yourself. Basically speaking, I'm the greatest enemy of myself.
- Idiosyncratic attitude, rage is one of my uncontrollable and unexpected characteristic that I feel it so annoying. Therefore, I'm trying to build my own serenity through my trained habits and sense of humour to neutralize that immense ammount of rage in myself. I believe the real power lies between rage and serenity (yup, inspired from professor X from X-Men), now that I already have rage, serenity is only thing left to go.
- Perfectionsism. Actually, this is some kind of siblings to the imposter syndrome that I mentioned two bullet points before. Sometimes, it drives me to finish something as full fledged and end-to-end as possible, some other times, it drives me to craziness or gives me unfathomable amount of stress and unsatisfaction. Still working a lot to tame this beast :D -->

# How To Reach Me

- [**GitHub**](https://github.com/dzungphieuluuky): Trying to build up some experience and store it here.
- [**Blog**](https://dzungphieuluuky.github.io/blog/): Read my thoughts and ideas on random topics.
- [**Email**](mailto:dungngocpham171@gmail.com): Email, just in case someone wants to discuss something related to deep learning especially diffusion and deep RL.